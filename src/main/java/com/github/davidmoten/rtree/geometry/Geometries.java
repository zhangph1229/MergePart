...
public final class Geometries {
    ...
    public static Point point(double x, double y, int id) {
        return Point.create(x, y, id);
    }
    ...
    public static Point pointGeographic(double lon, double lat, int id) {
        return point(normalizeLongitude(lon), lat, id);
    }
