...
public class SortTree2 {
    ...
    public static void main(String[] args) {
        ...
        SortTree2 st = new SortTree2();

//		String file = args[0];
//		r= Double.parseDouble(args[1]);
		String file = "F:/program/java/MergePart/t-drive-100.txt";
		...
		try {
			...
			while ((line = allData.readLine()) != null) {
				...
				if (flag == tra) {
					...
					seg_table = SortTree2.constructSegTable(points);
					stackList = SortTree2.constructStack(seg_table, points);
					Node target = SortTree2.createTree(root, stackList, points, seg_table);
